...
# load the dataset
dataframe = pandas.read_excel('data0512.xlsx', usecols=[0], sep = ',')
...
dataset3 = Predict[0]
rng = pandas.date_range('01/01/2018', periods=len(dataset3), freq='D')
df1 = pandas.DataFrame(dataset3,index=rng,columns=['DataflowByDay_4G_GB'])
df2 = pandas.read_excel('data0512.xlsx',sep=',')
df3 = pandas.concat([df2,df1],ignore_index= False)
df3.to_excel('data0501.xlsx')
